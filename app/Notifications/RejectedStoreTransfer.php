...
class RejectedStoreTransfer extends Notification
{
    use Queueable;
     ...
     *
     * @param \App\Events\RejectedStoreTransfer $event
     * @return void
     */
    public function __construct(\App\Events\RejectedStoreTransfer $event)
    {
        $this->event = $event;
    }
