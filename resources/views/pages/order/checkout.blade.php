...
@section('content')
        ...
        <div class="row mt-3 mt-lg-5" id="checkout">
            <div class="col-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body p-2">
                        <div class="alert alert-danger my-2 d-none">Your cart is empty.</div>
                            ...
                            <div class="d-flex align-items-stretch bg-light p-2 my-2 d-none" id="item_template">
                                ...
                                <div class="mx-2 overflow-hidden">
                                    ...
                                    <div class="align-self-start">
                                        <div class="h6 text-primary my-0 item_cost"></div>
                                        <div class="text-muted small item_unit_price"></div>
                                    </div>
                                </div>
                ...
                <div class="row py-3 d-none">
                    ...
                    <div class="col-12 col-lg-2 d-grid d-lg-inline">
            ...
            <div class="col-12 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body p-2">
                        <p class="border-bottom my-1">Contact Information</p>
                        <a href="#" class="btn btn-primary btn-sm">
                            <div class="d-flex align-items-center">
                                <i class="material-icons fs-14">house</i>
                                <span class="ms-1 small">Set Address</span>
                            </div>
                        </a>

                        <p class="border-bottom mt-3">Contact Information</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="remove_dialog" tabindex="-1" aria-labelledby="attachment-modal-label" aria-hidden="true">
